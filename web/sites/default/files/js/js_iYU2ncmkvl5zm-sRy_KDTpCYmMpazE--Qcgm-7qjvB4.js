  ...
  new Vue({
    ...
    computed: {
      filteredHotels() {
        ...
        temp_hotels = this.showAvailable ? temp_hotels.filter(hotel => {hotel.isAvailable === this.showAvailable}) : temp_hotels;
        console.log(temp_hotels)
        if (this.selectedFilter === 'All') {
          temp_hotels = temp_hotels;
        } else {
